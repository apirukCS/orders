...
class ApiProduct {
  static Future<List<ProductModel>> fetchListAllProduct() async{
    ...
    String textExample = "**** สินค้าของเราเป็นผลผลิตจากสวนเอง การจัดเก็บหรือจัดส่งในบางครั้งอาจล่าช้ากว่าปกติไป 2-3 วัน "
    ...
    String textExampleEn = "*** Our products are produced from our own gardens. "
    ...
    return [
      ProductModel(
          ...
          image: "https://obs.line-scdn.net/0h1Ovs9BsbbmBLCkePaGIRN3FcbQ94Zn1jLzw_YxdkMFQxMyA1I252VWcDZFVgOCk-ImwjBWcDdVE0aCwyc292/w644"
      ),
      ProductModel(
          productId: 2,
      ...
      ProductModel(
          ...
          image: "https://img10.jd.co.th/n0/jfs/t49/261/197695592/117091/88fc598e/62cfb861Nb1ecb750.jpg!q70.jpg"
      ),
    ];
  }
}